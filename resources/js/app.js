...
Vue.component('add-edit-partner', require('./components/partner/AddEdit.vue').default);
Vue.component('add-edit-insurance', require('./components/settings/insurance/AddEdit.vue').default);
Vue.component('add-edit-service', require('./components/service/AddEdit.vue').default);
